...
// Membuang item dari List berdasarkan nilai
  ...
  print(
      "List produk setelah membuang item SUSU KENTAL:$products"); // Output: [SABUN, MIE INSTANT, KOPI]
// Membuang item dari List berdasarkan index
  int indexToRemove = 1;
  products.removeAt(indexToRemove);
  print(
      "List produk setelah membuang item pada index $indexToRemove: $products"); // Output: [SABUN, KOPI]
// Mengosongkan List
  products.clear();
